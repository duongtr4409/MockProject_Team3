    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        switch (labelSearch.getText()) {
            ...
            case "Search by Author": {
                dataBook = UserServices.searchByOption("author", edtSearch.getText());
                ViewListBook.showListBook(dataBook, jScrollPane1, tblResultSearch);
                break;
            }
            case "Search by Category": {
                dataBook = UserServices.searchByOption("category", edtSearch.getText());
                ViewListBook.showListBook(dataBook, jScrollPane1, tblResultSearch);
                break;
            }
            default: {
                dataBook = UserServices.searchByOption("bookTitle", edtSearch.getText());
                ViewListBook.showListBook(dataBook, jScrollPane1, tblResultSearch);
                break;
            }
